...
class _LoginState extends State<Login> {
        ...
        body: Container(
          ...
          child: Stack(
            children: [
              Column(
                children: [
                  Image.asset('assets/image/noimg.jpg', width: 125, height: 125,),
  ...
  _openTos() async{
    await canLaunch("https://penastudio.id/ebookapp/tos.html") ?
    await launch("https://penastudio.id/ebookapp/tos.html") : throw 'Could not launch url';
  }

  _openPP() async{
    await canLaunch("https://penastudio.id/ebookapp/privacy_policy.html") ?
    await launch("https://penastudio.id/ebookapp/privacy_policy.html") : throw 'Could not launch url';
  }
}
