...
import 'package:ebook_app/contoller/con_freebook.dart';
...
import 'package:ebook_app/view/bottom/library_free.dart';
import 'package:ebook_app/view/detail/category_detail.dart';
import 'package:ebook_app/view/detail/ebook_detail.dart';
import 'package:ebook_app/view/search/search.dart';
import 'package:ebook_app/widget/app_loader_widget.dart';
...
class _HomeState extends State<Home> {
  ...
  //Future<List<ModelEbook>>? getFree;
  //List<ModelEbook> listFree = [];
  ...
  void initState() {
    ...
    //getFree = fetchFreeBook(listFree, id as int);
