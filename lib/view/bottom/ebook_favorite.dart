...
//import '../../widget/app_loader_widget.dart';
  ...
  void initState() {
    ...
    prefLoad().then((value) {
      setState(() {
        ...
        name = value[1];
        email = value[2];
        getFavorite = fetchFavorite(listFavorite, id as int);
      });
    });
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('My Book', style: TextStyle(
            color: Colors.black
        ),),
      ),
                ...
                return Align(
                  ...
                  child: Center(
                    child: CircularProgressIndicator(
                      strokeWidth: 1.6, color: Colors.amber,
                    ),
                  ),
                );
              }
