...
import 'package:ebook_app/contoller/con_bycategory.dart';
...
class EbookFree extends StatefulWidget {
  int idCategory;
  EbookFree(
  ...
  @override
  _EbookFreeState createState() => _EbookFreeState();
}

class _EbookFreeState extends State<EbookFree> {
  ...
  void initState() {
    super.initState();
    getLatest = fetchFreeBook(listLatest, widget.idCategory=1);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('E-Book Free', style: TextStyle(
            color: Colors.black
        ),),
      ),
      body: Container(
