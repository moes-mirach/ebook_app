...
Future<List<ModelEbook>> fetchFavorite(List<ModelEbook> latest, int id) async{
  var response = await Dio().get(ApiConstant().baseUrl+ApiConstant().api+ApiConstant().favorite+id.toString()
