...
Future<List<ModelEbook>> fetchFreeBook(List<ModelEbook> latest, int id) async{
  var response = await Dio().get(ApiConstant().baseUrl+ApiConstant().api+ApiConstant().free+id.toString());
