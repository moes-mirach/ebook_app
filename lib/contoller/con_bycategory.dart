...
Future<List<ModelEbook>> fetchByCategory(List<ModelEbook> latest, int id) async{
  var response = await Dio().get(ApiConstant().baseUrl+ApiConstant().api+ApiConstant().ebookByCategory+id.toString());
